...
import './Auth.css'
import icon from '../../assets/grow.png'
    ...
    <section className='auth-section'>
      ...
      <div className='auth-contaner-2'>
        ...
        <form>
          ...
          {
            isSignup && (
              <p style={{ color:"#666767", fontSize:'13px'}}>Lorem<span style={{color:"blue"}}> Groww </span> ipsum dolor sit, amet consectetur<br/> adipisicing elit.<span style={{color:"blue"}}> Groww </span> Iusto voluptatem voluptates<br/> "reiciendis" illo non cum architecto.</p>
            )
          }
